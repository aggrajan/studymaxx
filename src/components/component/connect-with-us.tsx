...
export function ConnectWithUs() {
    ...
    return (
        <div className="bg-[#d9edff]  bg-no-repeat bg-cover bg-[url('/hero-pattern.webp')]" >
        <section className="relative px-4 md:px-6 pt-6 md:pt-12 md:pb-24 lg:pt-16 lg:pb-32 pb-12 container max-w-[100rem] z-10 overflow-hidden">
            
            <div className="flex flex-col items-center justify-center space-y-4 px-4 md:px-6 text-center z-10">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-7 gap-20 max-w-[100rem]">
                    <div className="flex flex-col items-center gap-4">
                        ...
                        <Button className="bg-blue-700 hover:bg-blue-800 z-10">Connect</Button>
                    </div>
                    <div className="flex flex-col items-center gap-4">
