              ...
              <div className="grid gap-2">
                ...
                <div className="flex items-center gap-2">
                  <div className="flex items-center gap-0.5">
                    {Array.from({length: review.rating}, (_, i) => i).map((star_index) => {
                      return <StarIcon key={`star_${index}_${star_index}`} className="w-5 h-5 fill-primary" />
                    })}
                    {Array.from({length: 5 - review.rating}, (_, i) => i).map((no_star_index) => {
